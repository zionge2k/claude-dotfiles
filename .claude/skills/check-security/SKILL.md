...
name: check-security
description: |
  Scan code for security vulnerabilities (OWASP Top 10, injection, XSS, etc.) and suggest improvements.
...
📍 위치: src/config.js:12
```javascript
const API_KEY = "xxxxxxxxxxxxxxxxxxxxxxxx"; // 취약점  # pragma: allowlist secret
````
