---
name: nukki
description: Generate high-quality product image cutouts (background removal + AI upscale) from product photos.
...
| 단계 | 도구 | 설명 |
|------|------|------|
| 배경 제거 | rembg (birefnet-general) | RGBA 투명 배경 누끼 (정밀 마스크) |
