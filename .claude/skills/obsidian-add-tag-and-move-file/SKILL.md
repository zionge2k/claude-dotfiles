---
name: obsidian-add-tag-and-move-file
description: Analyze an Obsidian file, assign hierarchical tags, and move it to the appropriate directory.
argument-hint: "[filename] [--dry-run] [--preserve-tags]"
...
1. tag를 부여하는 것은 ~/.claude/skills/obsidian-add-tag/SKILL.md 파일을 참고해서 진행하세요.
2. **적절한 디렉토리 결정**
   - vault의 폴더 구조 분석
