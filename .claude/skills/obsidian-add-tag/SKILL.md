---
name: obsidian-add-tag
description: Analyze Obsidian file content and assign or improve hierarchical tags.
argument-hint: "[filename] [--recursive] [--dry-run]"
...
4. '~/.claude/skills/obsidian-tagging-example/SKILL.md' 파일에서 실제 문서에 대해서 태그를 부여하는 예시 참고
5. **태그 적용**
